...
const IncidentResolve = () => {
    ...
    const [interimInvestigation, setInterimInvestigation] = useState({ assignTo: "", cc: "", redo: false });
    const [rootCauseAnalysis, setRootCauseAnalysis] = useState({ assignTo: "", cc: "", redo: false });
    const [correctiveAction, setCorrectiveAction] = useState({ assignTo: "", cc: "", redo: false });
    const [preventiveAction, setPreventiveAction] = useState({ assignTo: "", cc: "", redo: false });
                        ...
                        <div className='row mt-5'>
                            ...
                            <div>
                                <label class="form-check-label" for="flexCheckDefault" className='text_color '>
                                    ...
                                    <Checkbox
                                        ...
                                        onChange={() => handleSectionChange('Interim Investigation')}
                                    />
                                </label>
                                <label class="form-check-label" for="flexCheckDefault" className='text_color ml-3'>
                                    Root cause analysis
                                    <Checkbox
                                        ...
                                        <div className='row'>
                                            ...
                                            <div className='col-md-4'>
                                                ...
                                                <Form.Group className="mb-3" controlId="assignTo">
                                                    <Form.Label className='text_color'>Assign to <span className='star'>*</span></Form.Label>
                                                    <Form.Select
                                                        className='input_border'
                                                        aria-label="Default select example"
                                                        value={
                                                            selectedSection === 'Interim Investigation' ? interimInvestigation.assignTo :
                                                                selectedSection === 'Root cause analysis' ? rootCauseAnalysis.assignTo :
                                                                    selectedSection === 'Corrective action' ? correctiveAction.assignTo :
                                                                        preventiveAction.assignTo
                                                        }
                                                        onChange={(e) => handleFieldChange(selectedSection, 'assignTo', e.target.value)}
                                                    >
                                            ...
                                            <div className='col-md-4'>
                                                <Form.Group className="mb-3" controlId="cc">
                                                    <Form.Label className='text_color'>CC <span className='star'>*</span></Form.Label>
                                                    <Form.Select
                                                        className='input_border'
                                                        aria-label="Default select example"
                                                        value={
                                                            selectedSection === 'Interim Investigation' ? interimInvestigation.cc :
                                                                selectedSection === 'Root cause analysis' ? rootCauseAnalysis.cc :
                                                                    selectedSection === 'Corrective action' ? correctiveAction.cc :
                                                                        preventiveAction.cc
                                                        }
                                                        onChange={(e) => handleFieldChange(selectedSection, 'cc', e.target.value)}
                                                    >
                                                        <option>Please select</option>
                                            ...
                                            <div className='col-md-3'>
                                                <Form.Group className="mb-3" controlId="redo">
                                                    <Form.Label className='text_color'>Redo <span className='star'>*</span></Form.Label>
                                                    <Form.Check
                                                        type="checkbox"
                                                        label="Redo"
                                                        id="redoCheckbox"
                                                        checked={
                                                            selectedSection === 'Interim Investigation' ? interimInvestigation.redo :
                                                                selectedSection === 'Root cause analysis' ? rootCauseAnalysis.redo :
                                                                    selectedSection === 'Corrective action' ? correctiveAction.redo :
                                                                        preventiveAction.redo
                                                        }
                                                        onChange={(e) => handleFieldChange(selectedSection, 'redo', e.target.checked)}
                                                    // className="input_border"
                                                    />
                                                </Form.Group>
                                            </div>
                            ...
                            <div className='col-md-9'>
                                <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                                    ...
                                    <Form.Control className='input_border' as="textarea" rows={3} placeholder='Write your comments' />
                                </Form.Group>
                            </div>
                            ...
                            <Accordion className='mb-1 border' >
                                ...
                                <AccordionDetails>
                                    <div className='row mt-2'>
                                        <div className='col-md-6'>
                                            <textarea className='input_border' as="textarea" rows={2} placeholder='Write your findings' />
                                        </div>
                                        <div className='col-md-6'>
                                            <h4>upload atachment</h4>
                                        </div>
                                    </div>
                                ...
                                <AccordionDetails>
                                    <div>
                                                            ...
                                                            {whyInputs.map((input, index) => (
                                                                <TableRow key={index}>
                                                                    ...
                                                                    <TableCell>
                                                                        ...
                                                                        <IconButton onClick={whyInputshandleAddRow} disabled={whyInputs.length >= 5}>
                                        ...
                                        <div className='row mt-4'>
                                            <div className='col-md-6 '>
                                                <Form.Group className="mb-3" controlId="exampleForm.ControlTextarea1">
                                                    <Form.Label className='text_color'>Summary of root cause analysis</Form.Label>
                                            ...
                                            <Table>
                                                <TableHead>
                                                    <TableRow style={{ backgroundColor: "#4a6bce" }}>
                                                        <TableCell className='text-center fs-6 fw-bold text-white' style={{ width: "250px" }}>Action taken</TableCell>
                                                        <TableCell className='text-center fs-6 fw-bold text-white' style={{ width: "250px" }}>Supporting Document</TableCell>
                                                        <TableCell className='text-center fs-6 fw-bold text-white'>Date</TableCell>
                                    ...
                                    <div className='row mt-2'>
                                        <div className='col-md-6'>
                                            <Form.Group className="mb-0" controlId="exampleForm.ControlTextarea1">
                                                ...
                                                <Form.Control className='input_border' as="textarea" rows={2} placeholder='Write the comment' />
                                            </Form.Group>
                                        </div>
                                        <div className='col-md-6'>
                                            <h4>upload attachment</h4>
